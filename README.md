...
> 📚 **Comprehensive documentation is available in the [Wiki](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki)**
...
```bash
git clone https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction.git
cd Qi_IntraChr_InterChr_Interaction
uv sync
```
...
**Note:** For detailed installation instructions, troubleshooting, and GPU setup, see [Wiki: Installation Guide](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Installation).
...
📖 **For detailed guides:** See [Wiki: Quick Start](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Quick-Start) and [Wiki: Configuration](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Configuration)
...
### Getting Started
- [Installation Guide](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Installation) - Step-by-step installation
- [Quick Start Guide](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Quick-Start) - Get started in 5 minutes
- [Data Preparation](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Data-Preparation) - VCF and PED/MAP formats

### Usage
- [Configuration](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Configuration) - All configuration options
- [Model Architecture](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Model-Architecture) - Model design details
- [Output Files](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Output-Files) - Understanding results
- [Performance Monitoring](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Performance-Monitoring) - Runtime and memory

### Reference
- [Troubleshooting](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Troubleshooting) - Common issues
- [API Reference](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/API-Reference) - Programmatic usage
- [Contributing](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Contributing) - How to contribute
- [Code Structure](https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki/Code-Structure) - Project organization
...
- **GitHub Repository:** https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction
- **Wiki Documentation:** https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/wiki
- **Issues:** https://github.com/qiqizhang0325-afk/Qi_IntraChr_InterChr_Interaction/issues
